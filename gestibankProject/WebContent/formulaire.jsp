...
<body>
	...
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="form-group row text-right fcrea">
				<label class="col-md-2 control-label" for="txtfprenom">Pénom : </label>
				<div class="col-md-6">
			...
			<div class="form-group fcrea row text-right ">
				<label class="col-md-2 control-label" for="txtfville">Ville : </label>
				<div class="col-md-6">
			...
			<div class="form-group fcrea row text-right">
				<label class="col-md-2 control-label" for="selectbasic">Pays : </label>
				<div class="col-md-6">
			...
			<div class="form-group fcrea row text-right ">
				...
				<div class="col-md-4">
					<label class="radio-inline" for="radiofsitumari-0"> <input
						type="radio" name="radiofsitumari" id="radiofsitumari-0" value="1"
						checked="checked"> Célibataire
					</label> <label class="radio-inline" for="radiofsitumari-1"> <input
						type="radio" name="radiofsitumari" id="radiofsitumari-1" value="2">
						Marié(e) - Pacsé(e)
					</label> <label class="radio-inline" for="radiofsitumari-2"> <input
						type="radio" name="radiofsitumari" id="radiofsitumari-2" value="3">
						Veuf / Veuve
					</label>
				</div>
			</div>
